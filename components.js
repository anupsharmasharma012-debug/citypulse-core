        ...
        this.innerHTML = `
            <div style="background: ${bgColor}; color: ${textColor}; padding: 12px 16px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid ${borderColor}; position: sticky; top: 0; z-index: 100;">
                ...
                <div style="display: flex; align-items: center; gap: 14px;">
                    ...
                    ` : ''}
                    <div onclick="window.location.href='notifications-setup.html'" style="position: relative; cursor: pointer; width: 36px; height: 36px; display: flex; justify-content: center; align-items: center; border-radius: 50%; background: rgba(150,150,150,0.08);">
